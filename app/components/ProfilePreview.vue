        ...
        <GridLayout rows="auto, *, auto">
            ...
            <StackLayout v-show="!isLoading" row="0" height="60">
                <GridLayout rows="auto" columns="auto, *, auto" >
                    ...
                    <StackLayout col="2" margin="11, 25, 0, 0" :isEnabled="!isLoading" height="40" verticalAlignment="center" @tap="reportUser()" >
                        <Label horizontalAlignment="right" text="Report user" fontSize="11" color="black" />     
                    </StackLayout>
                </GridLayout>            
            </StackLayout>
            <!-- Main Content -->     
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            reportUser() {
                email.available().then(avail => {
                    ...
                    if(avail){
                        email.compose({
                            subject: `Report user: ${this.userData.userFirstName}`,
                            body: `I'm reporting user ${this.userData.userFirstName}. User id = ${this.userData.userID}`,
        ...
        created() {
            ...
            console.log("User ID imported from TripPreview " + this.sourceUserId)
